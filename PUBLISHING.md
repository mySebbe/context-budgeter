...
1. Create the GitHub repository at `https://github.com/mySebbe/context-budgeter`.
2. Create the PyPI project named `context-budgeter`.
3. In PyPI, add a Trusted Publisher for:
   - Owner: `mySebbe`
   - Repository: `context-budgeter`
